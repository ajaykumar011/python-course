...
class HybridAttacker(Wizard, Archer):   # notice the order, in that order only it will give preference in multiple inheritance
    def __init__(self, name, power, arrows):
        Wizard.__init__(self,name,power)
        Archer.__init__(self,name,arrows)

#Object intialisation starts here
